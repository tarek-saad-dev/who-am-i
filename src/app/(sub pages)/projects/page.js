...
export default function ProjectsPage() {
    return ( <
        ...
        <
        p className = "text-foreground text-base sm:text-lg leading-relaxed mb-6" > [Process description placeholder - This section will explain
            your design thinking, problem - solving approach, and methodology
        ] <
        /p> <
        ...
        Step 1 <
        /h3> <
        p className = "text-foreground/80" > [Process step placeholder] <
        /p> <
        /div> <
        div className = "custom-bg rounded-lg p-6" >
        <
